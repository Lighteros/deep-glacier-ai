...
function fe(e, t, n = "/") {
  ...
  return (
    ...
    i > -1 &&
      ((r = t.slice(0, i)),
      (u = t.slice(i + 1, g > -1 ? g : t.length)),
      (o = e(u))),
    g > -1 && ((r = r || t.slice(0, g)), (d = t.slice(g, t.length))),
    (r = kt(r ?? t, n)),
    { fullPath: r + (u && "?") + u + d, path: r, query: o, hash: X(d) }
  );
}
function St(e, t) {
...
function Qe(e, t) {
  ...
  for (const n in e) if (!Ct(e[n], t[n])) return !1;
  return !0;
}
function Ct(e, t) {
...
function Tt(e, t, n, r) {
  ...
  return (
    ...
    { pauseListeners: i, listen: f, destroy: l }
  );
}
...
function $t(e) {
  ...
  function u(i, f, s) {
    const l = e.indexOf("#"),
      a =
        l > -1
          ? (n.host && document.querySelector("base") ? e : e.slice(l)) + i
          : It() + e + i;
    try {
  ...
  function g(i, f) {
    const s = S({}, o.value, t.state, { forward: i, scroll: te() });
    u(s.current, s, !0);
...
function un(e) {
  ...
  const o = S(
    { location: "", base: e, go: r, createHref: Ot.bind(null, e) },
    t,
    n
  );
  return (
...
function K(e, t) {
  return S(new Error(), { type: e, [Ye]: !0 }, t);
}
function T(e, t) {
  return e instanceof Error && Ye in e && (t == null || !!(e.type & t));
}
const Oe = "[^/]+?",
  Bt = { sensitive: !1, strict: !1, start: !0, end: !0 },
  Ht = /[.+*?^${}()[\]/\\]/g;
function qt(e, t) {
  const n = S({}, Bt, t),
    r = [];
  ...
  for (const f of e) {
    ...
    for (let l = 0; l < f.length; l++) {
      ...
      if (a.type === 0)
        ...
        u.push({ name: R, repeatable: k, optional: C });
        const P = E || Oe;
        if (P !== Oe) {
          m += 10;
          try {
            ...
            throw new Error(
              `Invalid custom RegExp for param "${R}" (${P}): ` + M.message
            );
          }
        }
        let O = k ? `((?:${P})(?:/(?:${P}))*)` : `(${P})`;
        l || (O = C && f.length < 2 ? `(?:/${O})` : "/" + O),
          C && (O += "?"),
          (o += O),
          (m += 20),
          C && (m += -8),
    ...
    for (const a of e) {
      ...
      for (const m of a)
        if (m.type === 0) s += m.value;
          ...
          const { value: R, repeatable: k, optional: C } = m,
            E = R in f ? f[R] : "";
          if (L(E) && !k)
            throw new Error(
  ...
  return { re: d, score: r, keys: u, parse: g, stringify: i };
}
function zt(e, t) {
  let n = 0;
...
function Qt(e, t) {
  ...
  function d(s) {
    if (Fe(s)) {
      ...
      l > -1 &&
        (n.splice(l, 1),
        s.record.name && r.delete(s.record.name),
  ...
  function f(s, l) {
    let a,
      ...
      k;
    if ("name" in s && s.name) {
      if (((a = r.get(s.name)), !a)) throw K(1, { location: s });
      (k = a.record.name),
        (m = S(
          Me(
            l.params,
            a.keys
              .filter((P) => !P.optional)
              .concat(a.parent ? a.parent.keys.filter((P) => P.optional) : [])
              .map((P) => P.name)
          ),
          s.params &&
            Me(
      ...
      (R = s.path),
        ...
        a && ((m = a.parse(R)), (k = a.record.name));
    else {
      if (((a = l.name ? r.get(l.name) : n.find((P) => P.re.test(l.path))), !a))
        throw K(1, { location: s, currentLocation: l });
      (k = a.record.name),
    ...
    return { name: k, path: R, params: m, matched: C, meta: Yt(C) };
  }
  return (
    e.forEach((s) => u(s)),
    {
            ...
            f.then((s) => {
              if (!s)
                return Promise.reject(
                  new Error(`Couldn't resolve component "${g}" at "${d.path}"`)
                );
...
function $e(e) {
  const t = H(ne),
    ...
    o = N(() => {
      ...
      if (a > -1) return a;
      const m = je(i[f - 2]);
      return f > 1 && je(s) === m && l[l.length - 1].path !== m
        ? l.findIndex(G.bind(null, i[f - 2]))
        : a;
    }),
    ...
    d = N(
      () =>
        ...
        Qe(n.params, r.value.params)
    );
  function g(i = {}) {
    return rn(i)
      ? t[W(e.replace) ? "replace" : "push"](W(e.to)).catch(F)
      : Promise.resolve();
  }
  return {
    route: r,
...
const tn = qe({
    ...
    setup(e, { slots: t }) {
      const n = ot($e(e)),
        { options: r } = H(ne),
        o = N(() => ({
          [Be(e.activeClass, r.linkActiveClass, "router-link-active")]:
            n.isActive,
          [Be(
            e.exactActiveClass,
          ...
          ([f, s, l], [a, m, R]) => {
            s &&
              ...
              f &&
                s &&
                (!m || !G(s, m) || !a) &&
                (s.enterCallbacks[l] || []).forEach((k) => k(f));
          },
          { flush: "post" }
        ),
        () => {
          const f = o.value,
            ...
            l = g.value,
            a = l && l.components[s];
          if (!a) return He(n.default, { Component: a, route: f });
          const m = l.props[s],
            R = m
              ? m === !0
                ? f.params
          ...
          return He(n.default, { Component: C, route: f }) || C;
        }
      );
    },
  });
...
function fn(e) {
  ...
  function m(c, p) {
    let h, v;
    return (
      Fe(c) ? ((h = t.getRecordMatcher(c)), (v = p)) : (v = c), t.addRoute(v, h)
    );
  }
  function R(c) {
  ...
  function E(c, p) {
    ...
    let h;
    if (c.path != null) h = S({}, c, { path: fe(n, c.path, p.path).path });
    else {
      const y = S({}, c.params);
      for (const _ in y) y[_] == null && delete y[_];
      (h = S({}, c, { params: l(y) })), (p.params = l(p.params));
    }
    const v = t.resolve(h, p),
      b = c.hash || "";
    v.params = s(a(v.params));
    const A = St(r, S({}, c, { hash: vt(b), path: v.path })),
      w = o.createHref(A);
    return S(
      { fullPath: A, hash: b, query: r === Ie ? Zt(c.query) : c.query || {} },
      v,
  ...
  function V(c, p) {
    ...
    let D;
    return (
      !A && bt(r, v, h) && ((D = K(16, { to: _, from: v })), we(v, v, !0, !1)),
      (D ? Promise.resolve(D) : ye(_, v))
        .catch((x) => (T(x) ? (T(x, 2) ? x : ce(x)) : se(x, _, v)))
        .then((x) => {
          if (x) {
            if (T(x, 2))
              return V(
      ...
      q(h)
        ...
        .then(
          () => (
            ...
            (h = he(A, "beforeRouteEnter", c, p, re)),
            h.push(w),
            q(h)
          )
        )
  ...
  function Ee(c, p, h, v, b) {
    ...
    h &&
      (v || w
        ? o.replace(c.fullPath, S({ scroll: w && y && y.scroll }, b))
        : o.push(c.fullPath, b)),
      (i.value = c),
      we(c, p, h, w),
      ce();
    ...
    U ||
      (U = o.listen((c, p, h) => {
        ...
        const v = E(c),
          b = I(v);
        if (b) {
          V(S(b, { replace: !0 }), v).catch(F);
          return;
        }
        f = v;
        const A = i.value;
        z && Lt(ke(A.fullPath, h.delta), te()),
          ye(v, A)
            .catch((w) =>
              T(w, 12)
                ? w
                ...
                ? (V(w.to, v)
                    ...
                    .catch(F),
                  Promise.reject())
                : (h.delta && o.go(-h.delta, !1), se(w, v, A))
            )
            .then((w) => {
              (w = w || Ee(v, A, !1)),
                w &&
  ...
  function se(c, p, h) {
    ...
    const v = Pe.list();
    return (
      v.length ? v.forEach((b) => b(c, p, h)) : console.error(c),
      Promise.reject(c)
    );
  }
  function et() {
  ...
  function we(c, p, h, v) {
    ...
    const A =
      (!h && Nt(ke(c.fullPath, 0))) ||
      ((v || !h) && history.state && history.state.scroll) ||
      null;
    return rt()
      .then(() => b(c, p, A))
      .then((w) => w && Mt(w))
  ...
  const ee = new Set(),
    Se = {
      ...
      install(c) {
        const p = this;
        c.component("RouterLink", nn),
          c.component("RouterView", cn),
...
export { hn as a, un as b, fn as c, dn as u };
