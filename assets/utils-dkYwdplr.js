...
const ss = { render: rs },
  ...
  as = we(() => l("span", { class: "text-2xl font-title" }, "DeepGlacier", -1)),
  cs = [is, as],
  ls = { class: "w-28" },
  us = {
    class:
      ...
      const t = [
          ...
          { title: "Document", href: "https://docs.deepglacierai.pro" },
          {
            ...
            children: [
              {
                title: "Etherscan",
                href: "https://etherscan.io/token/0x29ce5f03961033fed9f334949898b5bfe438be4b",
              },
              {
                title: "Dextools",
                href: "https://www.dextools.io/app/en/ether/pair-explorer/0x29ce5f03961033fed9f334949898b5bfe438be4b",
              },
              {
                title: "Dexscreener",
                href: "https://dexscreener.com/ethereum/0x29ce5f03961033fed9f334949898b5bfe438be4b",
              },
            ],
          },
          {
            ...
            children: [
              {
                title: "Twitter",
                desc: "Follow X",
                href: "https://x.com/DeepGlacierAI",
              },
              {
                title: "Telegram",
                desc: "Join Community",
                href: "https://t.me/DeepGlacierAI",
              },
            ],
          },
        ],
  ...
  ct = [
    { title: "Twitter", href: "https://x.com/DeepGlacierAI" },
    { title: "Telegram", href: "https://t.me/DeepGlacierAI" },
  ],
  Ms = {
    xmlns: "http://www.w3.org/2000/svg",
    width: "36",
...
const Zs = { render: Qs },
  ...
  co = De(() =>
    l(
      "div",
      { class: "text-white/80" },
      " DeepGlacier is building the first Data-centric Blockchain to supercharging AI at scale ",
      -1
    )
  ),
  lo = {
      ...
      const t = [j(js), j(Hs), j(Ws), j(Zs)],
        n = [
          ...
          },
          {
            title: "DEEPGLC Token",
            items: [
              { title: "Etherscan", href: "https://etherscan.io/token/0x29ce5f03961033fed9f334949898b5bfe438be4b" },
              { title: "Uniswap", href: "https://app.uniswap.org/#/swap?inputCurrency=eth&outputCurrency=0x29ce5f03961033fed9f334949898b5bfe438be4b" },
              { title: "Dexscreener", href: "https://dexscreener.com/ethereum/0x29ce5f03961033fed9f334949898b5bfe438be4b" },
              { title: "Dextools", href: "https://www.dextools.io/app/en/ether/pair-explorer/0x29ce5f03961033fed9f334949898b5bfe438be4b" },
            ],
          },
  ...
  return await (
    await fetch(`${ye}/connect`, {
      ...
      headers: {
        ...
        "X-DeepGlacierDB-Version": "0.0.1",
        "X-DeepGlacierDB-Sign": `ethsign ${t}`,
        "X-DeepGlacierDB-SignExpiredAt": n.toString(),
        "X-DeepGlacierDB-Nonce": r.toString(),
      },
    })
  ).json();
}
